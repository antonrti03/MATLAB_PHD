function [SM, EN, SYr, SXr, SE, SG, OPP]=Extrema_Single_Straightforward(img)
% Created by Anton and Tsvetkov, BSUIR, 2019: Straightforward [9]
% using raster scan order 3x3-neighbors.
%
...
while y<Y
    ...
    while x<X
        N=N+11;
        % Scanning Mask: [1 2 3; 4 0 5; 6 7 8]
        S1=img(y-1,x-1); S2=img(y-1,x); S3=img(y-1,x+1);
        S4=img(y,x-1);   S0=img(y,x);   S5=img(y,x+1);
