function [SM, EN, SYr, SXr, SE, SG, OPP]=Extrema_Single_Scanline(img)
% Created by Anton and Tsvetkov, BSUIR, 2019: from Scanline order, Tuan Pham [13]
% using scanline order 3x3-neighbors. 
%
